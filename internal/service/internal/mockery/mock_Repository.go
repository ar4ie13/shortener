...
// MockRepository_DeleteUserShortURLs_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DeleteUserShortURLs'
type MockRepository_DeleteUserShortURLs_Call struct {
	*mock.Call
}
...
func (_c *MockRepository_DeleteUserShortURLs_Call) Return(_a0 error) *MockRepository_DeleteUserShortURLs_Call {
	_c.Call.Return(_a0)
	return _c
}
...
// MockRepository_GetUserShortURLs_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetUserShortURLs'
type MockRepository_GetUserShortURLs_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - userUUID uuid.UUID
func (_e *MockRepository_Expecter) GetUserShortURLs(ctx interface{}, userUUID interface{}) *MockRepository_GetUserShortURLs_Call {
	return &MockRepository_GetUserShortURLs_Call{Call: _e.mock.On("GetUserShortURLs", ctx, userUUID)}
}

func (_c *MockRepository_GetUserShortURLs_Call) Run(run func(ctx context.Context, userUUID uuid.UUID)) *MockRepository_GetUserShortURLs_Call {
	_c.Call.Run(func(args mock.Arguments) {
