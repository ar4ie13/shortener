...
Изменил хэндлер PostURLJSONBatch, убрав лишнее чтение тела запроса в буфер, декодируюя тело напрямую в структуру.
Также изменил аллокацию слайса URL структуры с заданной длиной для избежания копирования при аппендах. И преаллоцировал
слайс ответа с заданием длины. Это помогло слегка снизить потребляемую память.
